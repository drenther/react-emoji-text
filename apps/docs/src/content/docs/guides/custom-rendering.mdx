...
import CustomRenderingPlayground from '../../../components/CustomRenderingPlayground';
...
Emojis render bold with a highlight. Unknown shortcodes render as inline code:

<CustomRenderingPlayground client:load />
